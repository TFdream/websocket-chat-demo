...
import websocket.commons.util.CollectionUtils;

import java.util.List;

/**
 * 全局跨域
 * 解决：https://crm2.iqianjin.com 和 https://crm-ws.iqianjin.com
 */
@Configuration
public class HttpCorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        if (CollectionUtils.isEmpty(allowedOrigins)) {
            ...
            LOG.info("客服呼叫中心-HTTP跨域, 允许全部原始域");
        } else {
            config.setAllowedOrigins(allowedOrigins);
            LOG.info("客服呼叫中心-HTTP跨域, 增加允许原始域:{}", allowedOrigins);
        }
        //是否发送Cookie信息
        ...
        if (CollectionUtils.isEmpty(allowedMethods)) {
            ...
            LOG.info("客服呼叫中心-HTTP跨域, 增加允许方法:{}", allowedMethods);
        }
        ...
        if (CollectionUtils.isNotEmpty(exposedHeaders)) {
            ...
            LOG.info("客服呼叫中心-HTTP跨域, 增加允许Header:{}", exposedHeaders);
        }
